...
class CheckinsControllerTest < ActionController::TestCase
  ...
  test "should create checkin" do
    assert_difference('Checkin.count') do
      post :create, checkin: { is_checked_in: @checkin.is_checked_in, user_id: @checkin.user_id, venue_id: @checkin.venue_id }
    end
  ...
  test "should update checkin" do
    patch :update, id: @checkin, checkin: { is_checked_in: @checkin.is_checked_in, user_id: @checkin.user_id, venue_id: @checkin.venue_id }
    assert_redirected_to checkin_path(assigns(:checkin))
  end
